...
function PressPage() {
	return (
		<Layout title="Press - Dextracker" defaultSEO>
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				<h2 className="font-semibold text-lg">About Dextracker</h2>
				<hr className="border-black/20 dark:border-white/20" />
				<p>
					Dextracker is the largest TVL aggregator for DeFi (Decentralized Finance). Our data is fully{' '}
					<a
						className="text-[var(--blue)] hover:underline"
						target="_blank"
						rel="noopener noreferrer"
						href="https://github.com/Dextracker/Dextracker-Adapters"
					>
						open-source
					</a>{' '}
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href="https://github.com/CodingWith1T/Dextracker/graphs/contributors"
					>
						contributors
					</a>{' '}
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				...
				<p>
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href="https://twitter.com/Dextracker"
					>
						Twitter
					</a>{' '}
					or{' '}
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						href="https://discord.Dextracker.com"
					>
						Discord
					</a>{' '}
					or by email{' '}
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md">
				...
				<hr className="border-black/20 dark:border-white/20" />
				<p>Dextracker is used across a large number of media organisations and financial institutions.</p>
