...
function PressPage({ protocols }) {
	return (
		<Layout title="Donations - Dextracker" defaultSEO>
			...
			<div className="flex flex-col gap-4 border border-black/10 dark:border-white/10 p-5 rounded-md mt-2">
				...
				<p>
					Dextracker is an open-source project that runs no ads and provides all data for free. We have no revenue and
				...
				<div className="flex flex-col gap-2">
					<p>
						Dextracker has referral links for all these protocols, using them with our referral sends us some rewards:
					</p>
				...
				<div className="flex flex-col gap-2">
					...
					<ul className="flex flex-col gap-1">
						<li>Pay the llamas working on Dextracker</li>
						<li>Cover costs associated with running Dextracker (this is mostly server costs)</li>
					</ul>
				</div>
			</div>
		</Layout>
