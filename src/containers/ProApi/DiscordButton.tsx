...
const DiscordButton = () => {
	...
	const handleClick = () => {
		const discordOAuthUrl =
			'https://discord.com/oauth2/authorize?client_id=1233371206346866719&response_type=code&redirect_uri=https://Dextracker.com/pro-api&scope=identify+guilds.join'
