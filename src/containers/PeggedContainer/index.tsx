...
export default function PeggedContainer(props) {
	...
	return (
		<Layout
			title={`${name}: Circulating and stats - Dextracker`}
				...
				<div className="flex flex-col col-span-1 w-full xl:w-[380px] text-[var(--text1)] bg-[var(--bg7)] overflow-x-auto">
					...
					<TabPanel state={tab}>
						<div className="flex items-center gap-4 flex-wrap p-6">
							...
							<ButtonLight
								as="a"
								href={`https://github.com/CodingWith1T/peggedassets-server/tree/master/src/adapters/peggedAssets/${gecko_id}`}
								target="_blank"
								rel="noopener noreferrer"
								useTextColor={true}
								color={backgroundColor}
