...
export const SEO = ({
	...
	const cardURL = useMemo(() => {
		...
		let images = nftPage
			? [`https://Dextracker.com/DefiLlama-press-kit/nft/SVG/Dextracker.svg`] // raghav
			: [`https://Dextracker.com/DefiLlama-press-kit/defi/SVG/Dextracker.svg`]
		...
		if (logo) {
			...
			images = [...images, `https://Dextracker.com${chainIconUrl(chain)}`]
		} else {
			if (token && token !== 'All') {
				images = [...images, `https://Dextracker.com${tokenIconUrl(token)}`]
			}
		}
	...
	return (
		<Head>
			<meta
				name="description"
				content="Dextracker is a DeFi TVL aggregator. It is committed to providing accurate data without ads or sponsored content, as well as transparency."
			/>

			<meta property="og:title" content="Dextracker" />
			<meta property="og:type" content="website" />
			<meta property="og:url" content={windowURL} />
			<meta property="og:site_name" content="Dextracker" />
			<meta
			...
			<meta property="twitter:domain" content="Dextracker.com" />
			<meta property="twitter:url" content={windowURL} />
			<meta name="twitter:title" content="Dextracker" />
			<meta name="twitter:site" content="@Dextracker" />
			<meta name="twitter:creator" content="@Dextracker" />
			<meta
