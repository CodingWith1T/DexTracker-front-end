...
rclone --config scripts/rclone.conf copy ./.next/static artifacts:Dextracker-app-artifacts
rclone --config scripts/rclone.conf copy artifacts:Dextracker-app-artifacts ./.next/static
